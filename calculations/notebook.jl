...
#> [frontmatter]
#> image = "https://imgs.search.brave.com/ZSdY5pXLSoz9dr-o7th1MvYUhi0eVZ7jE04PQyDHb7Y/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvMTU3/NTIzODAxL3Bob3Rv/L3J1c3R5LWh1Z2Ut/cGlwZXMuanBnP3M9/NjEyeDYxMiZ3PTAm/az0yMCZjPWJ1WFJs/SEo5QWIwcUNZdUVQ/RkVwS3Z0aUI3VXIt/MDMwWktGOG5lSEhD/TEk9"
#> language = "en-US"
#> title = "MSEN 646 - 600 Homework 4"
#> date = "2026-02-21"
#> tags = ["Corrosion", "Homework"]
#> description = "Homework for Dr. Homero Castañeda"
#> 
#>     [[frontmatter.author]]
...
# ╔═╡ 28e47b20-d9bf-4a8c-921f-4dacce23e3c8
using PlutoUI, Handcalcs, Unitful

# ╔═╡ 7e7810c0-0fae-11f1-ad08-41170ab92b71
md"""
# MSEN 646 Homework 4

This is a Julia Notebook that walks through the solution for MSEN 646 - 600 Homework #4.
"""
...
begin
	...
	t = 2u"m" # Depth of the anode ground bed
	a = 15.5u"mm^2" # Wire cross section
	d_bf = 1.25u"m" # Radius of the backfill
	d_a = 0.28u"m" # Radius of the anode
	W_a = 68u"kg" # Weight of a single anode of Fe-Si
	R = 0.07u"kg/A/yr" # Anode wear rate
	I_a = 5.0u"A" # Accepted current per anode
end;
...
| Potential increase measured at the end of the section | $ΔE_L 		|
| Attenuation coefficient 								| $α 			|
| Protected pipe length 								| $L 			|
| Measured potential increase at the drainage point 	| $ΔE_om 		|
...
| Depth of the anode ground bed 						| $t 			|
| Wire cross section 									| $a 			|
| Radius of the backfill 								| $d_bf 		|
| Radius of the anode 									| $d_a 			|
| Weight of a single anode of Fe-Si 					| $W_a 			|
| Anode wear rate 										| $R 			|
...
Determine the potential at the drainage point. Compare it with the measured value.
"""
...
Determine the number of anodes in the ground-bed.
"""
...
Determine the rectifier power needed.
"""
...
Determine the anode wear and cycling life of the system.
"""
...
manifest_format = "2.0"
project_hash = "968c5a1904db57da3cc07215b35ce35c6a9df221"
